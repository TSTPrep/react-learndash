    ...
    return (
        <>
            ...
            >
                ...
                <g>
                    <circle className='st0' cx='11.88' cy='6.09' r='4.09' />
                    <path
                        className='st0'
                        d='M8.95,14.04l0.79,0.58c1.23,0.91,2.94,0.79,4.03-0.3l0,0c0.58-0.58,1.37-0.9,2.19-0.9h0
		...
		c0-1.47-1.2-2.67-2.67-2.67h0c-1.11,0-2.02-0.9-2.02-2.02v-8.72c0-2.62,2.12-4.73,4.74-4.73h0C7.78,13.43,8.42,13.64,8.95,14.04z'
                    />
                    <line className='st1' x1='11.81' y1='41.19' x2='11.81' y2='27.07' />
                    <path
                        className='st2'
                        d='M19.21,2h20.76c1.16,0,2.11,0.94,2.11,2.11v21.56c0,1.16-0.94,2.11-2.11,2.11H20.76'
                    />
                    <line className='st2' x1='23.29' y1='6.85' x2='34.96' y2='6.85' />
                    <line className='st2' x1='23.29' y1='11.67' x2='28.83' y2='11.67' />
                    <line className='st2' x1='34.61' y1='11.49' x2='28.97' y2='17.13' />
                    <line className='st1' x1='1.93' y1='42' x2='34.46' y2='42' />
                </g>
            </svg>
        </>
    );
