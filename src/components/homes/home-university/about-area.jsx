...
const tabs = {
    ...
    content: [
        ...
        },
        {
            ...
            feature_list: ['Industry Expert Instructor', 'Up-to-Date Course Content'],
        },
        {
            id: 'about-vision',
            ...
            feature_list: ['Online Remote Learning', 'Lifetime Access For Learning'],
        },
    ],
};
                    ...
                    >
                        <div className='about-content'>
                            <div className='section-title section-left'>
                                ...
                                <h2 className='title'>
                                    We Provide Best{' '}
                                    <span className='color-primary'>Education</span>{' '}
                                    Services For You
                                </h2>
