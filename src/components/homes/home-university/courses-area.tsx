...
const CoursesArea = () => {
    ...
    const category_items = courses.filter(course =>
    ...
    const handleCategoryItems = c => {
        setCategory(c);
        const filtering_category_courses = courses.filter(course =>
            ...
            <div className='container'>
                ...
                <div className='isotope-wrapper'>
                    <div className='isotop-button'>
                        <button
                            onClick={() => handleCategoryItems('undergraduate')}
                            className={category === 'undergraduate' ? 'is-checked' : ''}
                        >
                            <span className='filter-text'>Undergraduate Program</span>
                        </button>
                        <button
                            onClick={() => handleCategoryItems('graduate')}
                            className={category === 'graduate' ? 'is-checked' : ''}
                        >
                            <span className='filter-text'>Graduate Program</span>
                        </button>
                        <button
                            onClick={() => handleCategoryItems('online')}
                            className={category === 'online' ? 'is-checked' : ''}
                        >
