...
import SwiperType, { Navigation, Thumbs } from 'swiper';
...
const { pre_title, testimonial_data, title } = testimonial_contents;

const Testimonial = () => {
    const [loop, setLoop] = useState(false);
    const [activeThumb, setActiveThumb] = useState<SwiperType | undefined>();
