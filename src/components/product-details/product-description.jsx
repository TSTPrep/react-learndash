            ...
            <div className='container'>
                <div className='row'>
                    <div className='col-lg-12'>
                        <ul
                            className='product-description-nav nav nav-tabs'
                            id='myTab'
                            role='tablist'
                        >
                        ...
                        <div className='tab-content' id='myTabContent'>
                            <div
                                className='product-description-content tab-pane fade show active'
                                id='desc'
                                role='tabpanel'
                            ...
                            <div
                                className='product-description-content tab-pane fade'
                                id='review'
                                role='tabpanel'
