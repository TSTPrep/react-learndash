                        ...
                        <div className='col-lg-8'>
                            <div className='details-content'>
                                ...
                                <p>
                                    ...
                                    pariatur enim ipsam voluptatem quia voluptas sit
                                ...
                                <ul className='event-meta'>
                                    <li>
                                        <i className='icon-40'></i>Newyork City, USA
                                    </li>
                                    <li>
                                        <i className='icon-71'></i>+012 (345) 6789
                                    </li>
                                </ul>
