                                            ...
                                            <div className='course-tab-content'>
                                                <div className='course-overview'>
                                                    ...
                                                    <p>
                                                        ...
                                                        do eiusmod tempor inc idid unt ut
                                                    ...
                                                    <ul className='mb--50'>
                                                        <li>
                                                            ...
                                                            Wordpress is required as
                                                            everything will be covered in
                                                            this course.
                                                        </li>
                                                        <li>
                                                        ...
                                                        <li>
                                                            ...
                                                            experience at all. That is the
                                                            beauty of Wordpress.
                                                        </li>
                                                        <li>
                                                            Basic JavaScript knowledge is
                                                            required
                                                        </li>
                                                    </ul>
