                        ...
                        <div className='course-details-content course-details-2'>
                            <div className='course-overview'>
                                        ...
                                        >
                                            <ul>
                                                <li>
                                                    ...
                                                    learning both Python 2 & Python 3!
                                                </li>
                                                <li>
                                                    Build 6 beautiful real-world projects
                                                    for your portfolio (not boring toy
                                                    apps)
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        >
                                            <ul>
                                                <li>
                                                    ...
                                                    and use it in Real Projects
                                                </li>
                                                <li>
                                                    Create responsive, accessible, and
                                                    beautiful layouts
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                >
                                    ...
                                    <li>
                                        Basic HTML and CSS knowledge helps, but {"isn't"}{' '}
                                        a must-have
                                    </li>
                                    <li>
                                        You {"don't"} need any coding experience at all.
                                        That is the beauty of Wordpress.
                                    </li>
                                ...
                                >
                                    <li>
                                        ...
                                        developers interested in learning a modern
                                        JavaScript framework
                                    </li>
                                    <li>
                                        If you want to learn to master Wordpress without
                                        getting bogged down with technical jargon, this
                                        course is for you.
                                    </li>
                                    <li>
                                        This course is for you if you want to build a
                                        website, whether for personal or business reasons.
                                    </li>
                                    <li>
                                        This course is perfect for you if you are taking
                                        over an existing Wordpress website, or want to
                                        build one from
                                    </li>
                                </ul>
                            </div>
